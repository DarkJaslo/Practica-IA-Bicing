...
library(data.table)
res3 <- read.table("SA5.txt", header = TRUE, sep = "\t")

par1 <- subset(res3, par=="1|0.01")
par2 <- subset(res3, par=="1|0.001")
par3 <- subset(res3, par=="1|5.0E-4")
par4 <- subset(res3, par=="1|1.0E-4")
par5 <- subset(res3, par=="1|1.0E-5")
par6 <- subset(res3, par=="5|0.01")
par7 <- subset(res3, par=="5|0.001")
par8 <- subset(res3, par=="5|5.0E-4")
par9 <- subset(res3, par=="5|1.0E-4")
par10 <- subset(res3, par=="5|1.0E-5")
par11 <- subset(res3, par=="10|0.01")
par12 <- subset(res3, par=="10|0.001")
par13 <- subset(res3, par=="10|5.0E-4")
par14 <- subset(res3, par=="10|1.0E-4")
par15 <- subset(res3, par=="10|1.0E-5")
par16 <- subset(res3, par=="20|0.01")
par17 <- subset(res3, par=="20|0.001")
par18 <- subset(res3, par=="20|5.0E-4")
